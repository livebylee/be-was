...
class CreateUserTest {
    ...
    void usercreationsuccess() throws Exception {
        ...
        String body = "userId=pobi&password=password&name=pobis&email=pobi@nextstep.com";
